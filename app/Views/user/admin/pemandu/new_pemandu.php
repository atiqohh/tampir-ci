            ...
            <div class="ibox">
                <div class="ibox-head">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary text-center">TAMBAH DATA PEMANDU</h6>
                    </div>
                </div>
                <br>
                <div class="ibox-body">
                    <form class="form-horizontal" id="form-sample-1" method="post" action="<?= base_url(); ?>/user/admin/pemanduadmin/save" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                        <div class="form-group row ml-3">
                            <label class="col-sm-2 col-form-label " for="nama_pemandu">Nama</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-p form-control <?= ($validation->hasError('nama_pemandu')) ? 'is-invalid' : ''; ?>" name="nama_pemandu" id="nama_pemandu" placeholder="Nama Pemandu" value="<?= old('nama_pemandu'); ?>" autofocus>
