    ...
    <div class="card shadow mb-4">
        <div class="col">
            <div class="ibox">
                ...
                <br>
                <div class="ibox-body">
                    <form class="form-horizontal" id="form-sample-1" method="post" action="<?= base_url(); ?>/user/admin/pengumumanadmin/save" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                        <div class="form-group row ml-3">
                            <label class="col-sm-2 col-form-label" for="judul_pengumuman">Judul</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control <?= ($validation->hasError('judul_pengumuman')) ? 'is-invalid' : ''; ?>" name="judul_pengumuman" id="judul_pengumuman" placeholder="Judul pengumuman" value="<?= old('judul_pengumuman'); ?>" autofocus>
                        ...
                        <div class="form-group row ml-3">
                            ...
                            <div class="col-sm-10">
                                <input type="file" class="form-control <?= ($validation->hasError('lampiran')) ? 'is-invalid' : ''; ?>" multiple="true" name="lampiran" id="lampiran" value="<?= old('lampiran'); ?>" autofocus>
                                <div class="invalid-feedback">
                        ...
                        <div class="form-group row ml-3">
                            ...
                            <div class="col-sm-10">
                                <textarea name="isi_pengumuman" id="isi_pengumuman" class="<?= ($validation->hasError('isi_pengumuman')) ? 'is-invalid' : ''; ?>" value="<?= old('isi_pengumuman'); ?>"><?= old('isi_pengumuman'); ?></textarea>
                                <script>
