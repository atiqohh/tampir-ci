            ...
            <div class="ibox">
                <div class="ibox-head">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary text-center">TAMBAH DATA PAKET WISATA</h6>
                    </div>
                </div>
                <br>
                <div class="ibox-body">
                    <form class="form-horizontal" id="form-sample-1" method="post" action="<?= base_url(); ?>/user/admin/paketadmin/save" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                        <div class="form-group row ml-3">
                            <label class="col-sm-2 col-form-label" for="nama_paket">Nama Paket</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control <?= ($validation->hasError('nama_paket')) ? 'is-invalid' : ''; ?>" name="nama_paket" id="nama_paket" placeholder="Nama paket wisata" value="<?= old('nama_paket'); ?>" autofocus>
                        ...
                        <div class="form-group row ml-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control <?= ($validation->hasError('harga_paket')) ? 'is-invalid' : ''; ?>" name="harga_paket" id="harga_paket" placeholder="Harga paket wisata" value="<?= old('harga_paket'); ?>">
                                <div class="invalid-feedback">
